...
M_.mapping.delta_e.eqidx = [6 ];
M_.mapping.pi.eqidx = [3 ];
M_.mapping.pih.eqidx = [1 2 3 5 ];
...
peg_results = oo_;
save peg_results;
save('peg1_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('peg1_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('peg1_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('peg1_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('peg1_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('peg1_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('peg1_results.mat', 'oo_recursive_', '-append');
end
