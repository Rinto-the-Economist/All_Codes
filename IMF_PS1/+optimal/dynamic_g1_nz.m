...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(2,1)=10; nzij_pred(2,2)=2;
  nzij_pred(3,1)=5; nzij_pred(3,2)=3;
  nzij_pred(4,1)=5; nzij_pred(4,2)=4;
  nzij_pred(5,1)=7; nzij_pred(5,2)=4;
  nzij_pred(6,1)=8; nzij_pred(6,2)=5;
  nzij_pred(7,1)=3; nzij_pred(7,2)=9;
  nzij_pred(8,1)=9; nzij_pred(8,2)=10;
  ...
  nzij_current(13,1)=1; nzij_current(13,2)=8;
  nzij_current(14,1)=3; nzij_current(14,2)=8;
