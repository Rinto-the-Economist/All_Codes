...
M_.endo_names(16) = {'n_a'};
M_.endo_names_tex(16) = {'n\_a'};
M_.endo_names_long(16) = {'n_a'};
M_.endo_names(17) = {'n_b'};
M_.endo_names_tex(17) = {'n\_b'};
M_.endo_names_long(17) = {'n_b'};
M_.endo_names(18) = {'r_star'};
M_.endo_names_tex(18) = {'r\_star'};
M_.endo_names_long(18) = {'r_star'};
M_.endo_names(19) = {'pi_r'};
M_.endo_names_tex(19) = {'pi\_r'};
M_.endo_names_long(19) = {'pi_r'};
M_.endo_names(20) = {'pi_h'};
M_.endo_names_tex(20) = {'pi\_h'};
M_.endo_names_long(20) = {'pi_h'};
...
M_.param_names(6) = {'s_t'};
M_.param_names_tex(6) = {'s\_t'};
M_.param_names_long(6) = {'s_t'};
...
M_.mapping.l.eqidx = [11 12 17 ];
M_.mapping.y_t.eqidx = [11 15 ];
M_.mapping.y_o.eqidx = [10 16 19 ];
M_.mapping.p_t.eqidx = [1 2 3 8 9 10 11 12 20 ];
M_.mapping.e.eqidx = [1 2 3 4 6 7 8 9 10 ];
M_.mapping.w.eqidx = [6 7 8 9 11 12 ];
M_.mapping.pi.eqidx = [12 13 14 ];
M_.mapping.n_a.eqidx = [9 18 ];
M_.mapping.n_b.eqidx = [10 18 ];
M_.mapping.r_star.eqidx = [4 5 9 10 ];
M_.mapping.pi_r.eqidx = [9 13 14 ];
M_.mapping.pi_h.eqidx = [8 13 ];
M_.mapping.err_yo.eqidx = [19 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [9 10 11 12 16 17 ];
...
oo_.steady_state(9) = M_.params(10)*oo_.steady_state(8)+(1-M_.params(10))*oo_.steady_state(7);
oo_.steady_state(10) = oo_.steady_state(9)^(1-M_.params(1));
oo_.steady_state(12) = 16.75/oo_.steady_state(10);
oo_.steady_state(5) = M_.params(6)^M_.params(5)*oo_.steady_state(13)^M_.params(5)*oo_.steady_state(2)/(oo_.steady_state(12)^M_.params(5)*(1-M_.params(6))^M_.params(5));
oo_.steady_state(4) = M_.params(6)^M_.params(5)*oo_.steady_state(13)^M_.params(5)*oo_.steady_state(1)/(oo_.steady_state(12)^M_.params(5)*(1-M_.params(6))^M_.params(5));
oo_.steady_state(6) = oo_.steady_state(10)-M_.params(10)*oo_.steady_state(5)-(1-M_.params(10))*oo_.steady_state(4);
oo_.steady_state(11) = M_.params(9)/(1-M_.params(8));
oo_.steady_state(3) = oo_.steady_state(11)-M_.params(10)*oo_.steady_state(2)-(1-M_.params(10))*oo_.steady_state(1);
oo_.steady_state(14) = oo_.steady_state(12)*(1-M_.params(1))*(1-M_.params(7))*oo_.steady_state(9)^((1-M_.params(1))*(1-M_.params(7))-1)*oo_.steady_state(10)^M_.params(7);
oo_.steady_state(15) = oo_.steady_state(9)^(1-M_.params(1))*oo_.steady_state(12)-oo_.steady_state(9)*oo_.steady_state(14);
oo_.steady_state(19) = oo_.steady_state(15);
oo_.steady_state(20) = (oo_.steady_state(15)-M_.params(10)*oo_.steady_state(19))/(1-M_.params(10));
oo_.steady_state(18) = 1/M_.params(2);
oo_.steady_state(16) = oo_.steady_state(18)/(oo_.steady_state(13)*(oo_.steady_state(18)-1))*(oo_.steady_state(12)*oo_.steady_state(5)+oo_.steady_state(13)*oo_.steady_state(2)-oo_.steady_state(9)*oo_.steady_state(14)-oo_.steady_state(19));
...
var_list_ = {'c_aho';'c_aro';'c_bo';'c_aht';'c_art';'c_bt';'l_h';'l_r';'l';'y_t';'y_o';'p_t';'e';'w';'pi';'n_a';'n_b';'r_star'};
[info, oo_, options_] = stoch_simul(M_, options_, oo_, var_list_);
model_diagnostics(M_,options_,oo_);
save('tanbnr_pit_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('tanbnr_pit_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('tanbnr_pit_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('tanbnr_pit_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('tanbnr_pit_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('tanbnr_pit_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('tanbnr_pit_results.mat', 'oo_recursive_', '-append');
end
