...
if T_flag
    T = tanbfpnh.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(19, 1);
residual(1) = T(2)-T(3)/y(15);
residual(2) = (1-params(5))*T(4)-T(5)/y(15);
residual(3) = (1-params(7))*T(6)-T(7)/y(15);
...
residual(13) = y(21)*params(11)+y(22)*(1-params(11))-y(17);
residual(14) = y(21)-y(17);
residual(15) = y(13)-y(7)*(1-params(11))-y(8)*params(11)-y(9);
residual(16) = y(14)-y(4)*(1-params(11))-y(5)*params(11)-y(6);
residual(17) = y(11)*params(11)+y(10)*(1-params(11))-y(12);
residual(18) = y(19)+y(18)*params(11);
residual(19) = params(10)+params(9)*y(1)-x(it_, 1)-y(14);
