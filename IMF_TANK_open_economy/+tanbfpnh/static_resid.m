...
if T_flag
    T = tanbfpnh.static_resid_tt(T, y, x, params);
end
residual = zeros(19, 1);
residual(1) = T(2)-T(3)/y(12);
residual(2) = (1-params(5))*T(4)-T(5)/y(12);
residual(3) = (1-params(7))*T(6)-T(7)/y(12);
...
residual(13) = y(18)*params(11)+y(19)*(1-params(11))-y(14);
residual(14) = y(18)-y(14);
residual(15) = y(10)-y(4)*(1-params(11))-y(5)*params(11)-y(6);
residual(16) = y(11)-y(1)*(1-params(11))-y(2)*params(11)-y(3);
residual(17) = y(8)*params(11)+y(7)*(1-params(11))-y(9);
residual(18) = y(16)+y(15)*params(11);
residual(19) = params(10)+y(11)*params(9)-x(1)-y(11);
if ~isreal(residual)
