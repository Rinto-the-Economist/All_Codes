...
M_.param_names(5) = {'s_art'};
M_.param_names_tex(5) = {'s\_art'};
M_.param_names_long(5) = {'s_art'};
M_.param_names(6) = {'s_aht'};
M_.param_names_tex(6) = {'s\_aht'};
M_.param_names_long(6) = {'s_aht'};
M_.param_names(7) = {'s_bt'};
M_.param_names_tex(7) = {'s\_bt'};
M_.param_names_long(7) = {'s_bt'};
...
M_.params(6) = .75;
s_aht = M_.params(6);
M_.params(5) = (s_t-(1-M_.params(11))*M_.params(6))/M_.params(11);
s_art = M_.params(5);
M_.params(7) = s_t;
s_bt = M_.params(7);
M_.params(8) = .68;
...
oo_.steady_state(9) = M_.params(11)*oo_.steady_state(8)+(1-M_.params(11))*oo_.steady_state(7);
...
oo_.steady_state(4) = M_.params(6)^M_.params(4)*oo_.steady_state(1)/(oo_.steady_state(12)^M_.params(4)*(1-M_.params(6))^M_.params(4));
oo_.steady_state(6) = oo_.steady_state(10)-M_.params(11)*oo_.steady_state(5)-(1-M_.params(11))*oo_.steady_state(4);
oo_.steady_state(11) = M_.params(10)/(1-M_.params(9));
oo_.steady_state(3) = oo_.steady_state(11)-M_.params(11)*oo_.steady_state(2)-(1-M_.params(11))*oo_.steady_state(1);
oo_.steady_state(13) = oo_.steady_state(12)*(1-M_.params(1))*(1-M_.params(8))*oo_.steady_state(9)^((1-M_.params(1))*(1-M_.params(8))-1)*oo_.steady_state(10)^M_.params(8);
...
oo_.steady_state(19) = (oo_.steady_state(14)-M_.params(11)*oo_.steady_state(18))/(1-M_.params(11));
...
save('tanbfpnh_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('tanbfpnh_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('tanbfpnh_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('tanbfpnh_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('tanbfpnh_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('tanbfpnh_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('tanbfpnh_results.mat', 'oo_recursive_', '-append');
end
