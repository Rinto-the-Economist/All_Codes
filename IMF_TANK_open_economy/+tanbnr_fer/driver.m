...
M_.NNZDerivatives = [83; -1; -1; ];
M_.static_tmp_nbr = [22; 9; 0; 0; ];
close all;
load parameters;
...
oo_.steady_state(5) = M_.params(6)^M_.params(5)*oo_.steady_state(2)/(oo_.steady_state(12)^M_.params(5)*(1-M_.params(6))^M_.params(5));
oo_.steady_state(4) = M_.params(6)^M_.params(5)*oo_.steady_state(1)/(oo_.steady_state(12)^M_.params(5)*(1-M_.params(6))^M_.params(5));
...
oo_.steady_state(13) = oo_.steady_state(12)*(1-M_.params(1))*(1-M_.params(7))*oo_.steady_state(9)^((1-M_.params(1))*(1-M_.params(7))-1)*oo_.steady_state(10)^M_.params(7);
oo_.steady_state(14) = oo_.steady_state(9)^(1-M_.params(1))*oo_.steady_state(12)-oo_.steady_state(9)*oo_.steady_state(13);
oo_.steady_state(18) = oo_.steady_state(14);
oo_.steady_state(19) = (oo_.steady_state(14)-M_.params(10)*oo_.steady_state(18))/(1-M_.params(10));
...
oo_.steady_state(16) = (-oo_.steady_state(15));
if M_.exo_nbr > 0
...
save('tanbnr_fer_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('tanbnr_fer_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('tanbnr_fer_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('tanbnr_fer_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('tanbnr_fer_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('tanbnr_fer_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('tanbnr_fer_results.mat', 'oo_recursive_', '-append');
end
