...
residual(2) = (1-params(6))*T(4)-T(5)/y(12);
residual(3) = (1-params(6))*T(6)-T(7)/y(12);
...
residual(7) = params(3)-y(13)*(1-params(6))*T(4)/T(9)*(1-y(8));
...
residual(11) = T(13)*T(14)-y(13)-T(15)*T(18)/T(21);
residual(12) = y(12)*T(22)-y(13)*y(9)-y(14);
residual(13) = y(18)*params(10)+y(19)*(1-params(10))-y(14);
...
residual(18) = y(16)+y(15)*params(10);
