...
if T_flag
    T = tanbfp.dynamic_g1_tt(T, y, x, params, steady_state, it_);
end
g1 = zeros(19, 27);
g1(1,4)=T(22);
...
g1(5,6)=(T(13)*T(25)-T(6)*(1-params(5))*getPowerDeriv(y(6),T(8),1))/(T(13)*T(13));
...
g1(6,4)=(-((1-y(10))*y(16)*(T(17)*T(22)-T(2)*(1-params(5))*getPowerDeriv(y(4),T(8),1))/(T(17)*T(17))));
